...
You can also choose **Upload a PDF** in the sidebar. PDF.js renders the file entirely in the browser with selectable text layers, page navigation, and zoom; selecting text sends that exact passage into the explanation pane. The original file is never uploaded to the Gloss server.
...
- ⌘K command palette searching papers, concepts, notes, and EverOS memory
- Per-learner profiles: reading time goals, feedback, notifications, and memory all follow the signed-in learner
